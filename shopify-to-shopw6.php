<?php
/*
 * Template Name: Shopify zu Shopware 6
 */
get_header(); ?>

<div class="page-shopify-to-shopware6">
...
<div class="center">
    <div class="banner-btn">
        ...
        <!-- <a aria-label="Chat on WhatsApp" href="<?php echo ( get_field('buttons-gr' ,11171)['button-link-wp'] );?>"><span></span><?php echo ( get_field('buttons-gr', 11171)['button-name-wp'] );?></a> -->
        <div class="whatsapp-btn">
...
<div class="banner-wrapper-new-pg">
    <div class="container">
        <div class="content-shopw">
				<?php
				$page_id = 11171; // Default language ID
				if ( pll_current_language() == 'en' ) {
					$page_id = 12205; // English version ID
				}
				?>
				<span><?php echo get_field('group_bronzepartner', $page_id)['bronze-txt']; ?></span>
				<img src="<?php echo get_field('group_bronzepartner', $page_id)['bronze-partner-desk']; ?>" class="desk-v" alt="shopware-bronz" loading="lazy">
				<img src="<?php echo get_field('group_bronzepartner', $page_id)['bronze-partner-mob']; ?>" class="mob-v" alt="shopware-bronz" loading="lazy">
			</div>
            </div>
        </div>
    </div>
...
<section class="differences-shpw">
    <div class="container">
        ...
        <div class="upside">
            <div class="lefts ">
            <img src="<?php the_field('icon-leftside');?>" class="shopify" alt="old-option" loading= “lazy”>
            </div>
            <div class="rights">
