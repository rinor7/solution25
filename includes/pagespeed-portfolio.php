    ...
    <div class="our-portfolio our-portfolio-pagespeed">
        <div class="container">
            <h1 class="portfolio-title"><?php pll_e( 'Portfolio posts title pagespeed' );?></h1>
        </div>
            ...
            <div class="swiper-wrapper">
                ...
                if (empty($direction)) {
                    ...
                    <div class="specific-direction">
                        <a href="<?php the_field('direct-link-post'); ?>">Case Study lesen</a>
                    </div>
                    <?php
                }
                ?>
